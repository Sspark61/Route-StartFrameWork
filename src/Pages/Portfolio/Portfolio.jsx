      ...
      <div className="container col-12">
        ...
        <div className="row mt-sm-2 mt-4 g-md-5 g-xs-2 d-flex justify-content-center align-items-center">
          <div className="col-xl-4 col-xs-12 col-sm-6 mt-sm-5 mt-4">
            <div className={`${styles.card} position-relative overflow-hidden rounded-3`}>
              <img src={port1} alt="" className="img-fluid" />
              <div className={`${styles.overlay} position-absolute w-100 h-100 top-0 start-0 d-flex align-items-center justify-content-center`}>
              <FontAwesomeIcon icon={faPlus} className={`${styles.faPlus} text-white`}/>
              </div>
            </div>
          </div>
          <div className="col-xl-4 col-xs-12 col-sm-6 mt-sm-5 mt-4">
          ...
          </div><div className="col-xl-4 col-xs-12 col-sm-6 mt-sm-5 mt-4">
            <div className={`${styles.card} position-relative overflow-hidden rounded-3`}>
            ...
            <div className={`${styles.card} position-relative overflow-hidden rounded-3`}>
              <img src={port3} alt="" className="img-fluid" />
              <div className={`${styles.overlay} position-absolute w-100 h-100 top-0 d-flex align-items-center justify-content-center`}>
              <FontAwesomeIcon icon={faPlus} className={`${styles.faPlus} text-white`}/>
              </div>
            </div>
          </div>
